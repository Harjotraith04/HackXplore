...
const navigation = (userId) => [
  { name: 'Dashboard', href: `/student/${userId}`, current: false },
  { name: 'Document', href: `/student/${userId}/document`, current: false },
  { name: 'Resource', href: `/student/${userId}/resource`, current: false },
  { name: 'Study Center', href: `/student/${userId}/quiz`, current: false },
  { name: 'Rooms', href: `/student/${userId}/rooms`, current: false },
];
...
export default function StudentNavBar({ userId }) {
  const navigate = useNavigate();
  const [isLoggedIn, setIsLoggedIn] = useState(true); // Replace this with your actual state management
